...
class unitTestWheat {
 ...
 protected:
  ...
  void testConstructor() {
    ...
    // correct setting.
    if (wheat.getSellPrice() != 15 && wheat.getBuyPrice() != 10 &&
        wheat.getSellTime() == 8 && wheat.getHighYieldPrice() == 10) {
  ...
  void testApplyHighYield() {
    ...
    // If statement to check if wheatHighYieldApplied is true and money has
    // decreased.
  ...
  void testEvent() {
    ...
    // Note that when random num gen taken out, below works. Otherwise, wheat
