...
// Sets the buyPrice.
void Farm::setBuyPrice(int buyPrice) { this->buyPrice = buyPrice; }

// Returns the buyPrice
int Farm::getBuyPrice() { return buyPrice; }

// sets the sellPrice
void Farm::setSellPrice(int sellPrice) { this->sellPrice = sellPrice; }

// returns the sellPrice
int Farm::getSellPrice() { return sellPrice; }

// sets the sellTime
void Farm::setSellTime(int sellTime) { this->sellTime = sellTime; }

// returns the sellTime.
int Farm::getSellTime() { return sellTime; }

// returns the timer.
int Farm::getTimer() { return timer; }

// returns barnSpeedGrowthApplied
bool Farm::getBarnSpeedGrowthApplied() { return barnSpeedGrowthApplied; }

// returns fieldSpeedGrowthApplied
bool Farm::getFieldSpeedGrowthApplied() { return fieldSpeedGrowthApplied; }
...
bool Farm::getPigHighYieldApplied() { return pigHighYieldApplied; }

// returns cowHighYieldApplied
bool Farm::getCowHighYieldApplied() { return cowHighYieldApplied; }

// returns wheatHighYieldApplied
bool Farm::getWheatHighYieldApplied() { return wheatHighYieldApplied; }

// returns cornHighYieldApplied
bool Farm::getCornHighYieldApplied() { return cornHighYieldApplied; }
...
bool Farm::isReadyToSell() {
  ...
  // determines if the time difference is greater than the sell time and returns
  // a boolean.
