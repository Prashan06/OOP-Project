...
int main(){
    ...
    cin >> optionChoice; //reading user input
        while (optionChoice != "Y" && optionChoice != "N") { //validating input and rerequesting if invalid
            cout << "invalid input! please enter Y or N" << endl;
            cin >> optionChoice; //reading user input
        }
        if(optionChoice == "Y") { //updating money variable in farmer to match saved value and displayng it
    ...
    while (*farmer.getMoneyCount() > 0){
        ...
        while (mainScreen == true){
            ...
            cout << "Hello " << farmer.getFarmName() << "!" << endl;    //welcoming player with inputed name
            ...
            while (optionChoice != "barn" && optionChoice != "field" && optionChoice != "status" && optionChoice != "quit"){ //validating input and rerequesting input if invalid
            ...
            } else if (optionChoice == "barn") { //exiting mainScreen loop and entering barnScreen loop
                barnScreen = true;
                mainScreen = false;
            } else if (optionChoice == "field"){ //exiting mainScreen loop and entering fieldScreen loop
                fieldScreen = true;
                mainScreen = false;
        ...
        while (barnScreen == true) {
            ...
            cout << "Welcome to the Barn! what action would you like to take?" << endl; //displaying options available to the player
            cout << "" << endl;
            ...
            cin >> optionChoice; //reading user input
            while (optionChoice != "buy" && optionChoice != "upgrade" && optionChoice != "sell" && optionChoice != "leave"){ //validating input & rerequesting if invalid
            ...
            if (optionChoice == "buy") {
                ...
                if (farmer.getProduct() == "cow" && *farmer.getCowCount() > 9){
                    for (int i = 0; i < *farmer.getCowCount(); i++){ //iterating through cow array
                    ...
                    for (int i = 0; i < *farmer.getPigCount(); i++){ //iterating through pig array
                        farmer.getPigArray()[i]-> Event(farmer.getPigCount());
                    }
                    farmer.executeEvent(); //calling executeEvent function
                }
            } else if (optionChoice == "sell") {
                farmer.sellAnimal(); //calling sellAnimal function (reuqests user input)
                ...
                cin >> optionChoice; //reading user input
                while (optionChoice != "yield" && optionChoice != "speed") { //validating user input & rerequesting if invalid
                    cout << "Invalid input enter speed or yield" << endl;
                    cin >> optionChoice; //reading uesr input
                }
                if (optionChoice == "speed") {
                    farmer.applySpeedGrowAnimals(); //calling applySpeedGrowAnimals function (requests user input)
                } else if (optionChoice == "yield") {
                   farmer.applyHighYieldAnimals(); //calling applyHighYieldAnimals function (requests user input)
                }
        ...
        while (fieldScreen == true) {
            cout << "welcome to the Field! what action would you like to take?" << endl; //displays options available to player
            cout << "" << endl;
            ...
            cin >> optionChoice; //reading user input
            while (optionChoice != "buy" && optionChoice != "upgrade" && optionChoice != "sell" && optionChoice != "pesticide" && optionChoice != "leave"){ //validating user input & rerequesting if invalid
            ...
            if (optionChoice == "buy") {
                ...
                if (farmer.getProduct() == "corn" && *farmer.getCornCount() > 9){
                    for (int i = 0; i < *farmer.getCornCount(); i++){ //iterating through corn array
                        farmer.getCornArray()[i]->Event(farmer.getCornCount());
                    }
                    farmer.executeEvent(); //calling executeEvent function
                }
                if (farmer.getProduct() == "Wheat" && *farmer.getWheatCount() > 9) {
                    for (int i = 0; i < *farmer.getWheatCount(); i++){ //iterating through wheat array
                ...
                cout << "To upgrade highYield, enter yield" << endl;
                cin >> optionChoice; //reading user input
                while (optionChoice != "speed" && optionChoice != "yield" ) { //validating input & rerequesting if invalid
                    cout << "Invalid input, re-enter your choice of action,  choose speed or yield." << endl;
                    cin >> optionChoice;
                }
                if (optionChoice == "speed") {
                    farmer.applySpeedGrowCrops(); //calling applySpeedGrowCrops function (requests user input)
                } else if (optionChoice == "yield") {
                   farmer.applyHighYieldCrops(); //calling applyHighYieldCrops function (requests user input)
                } 
            }else if (optionChoice == "pesticide") {
                    farmer.appliedPesticide(); //calling appliedPesticide function (requests user input)
