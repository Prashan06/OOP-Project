...
int Field::getSpeedGrowPrice() { return speedGrowPrice; }
...
int Field::getPesticidePrice() { return pesticidePrice; }
...
float Field::getHighYieldFactor() { return highYieldFactor; }
...
int Field::getHighYieldPrice() { return highYieldPrice; }

void Field::applySpeedGrowth(int* money) {
  // Below ensures the user has enough money to buy speedGrow.
  if (*money < speedGrowPrice) {
    cout << "You do not have enough money to buy the SpeedGrowth update, try "
            "again later"
         << endl;
  } else {
...
bool Field::getPesticideApplied() { return pesticideApplied; }
...
int Field::getSpeedGrowLevel() { return speedGrowLevel; }
...
bool Field::getSpeedGrowApplied() { return speedGrowApplied; }