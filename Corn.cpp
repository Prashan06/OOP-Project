...
// This functions sets cornEvent to true depending on the value of cornCount.
// The code to affect the corn is in Farmer
...
// This functions sets the cornHighYieldApplied to true. The code to increase
// the price of corn objects is in Farmer.
