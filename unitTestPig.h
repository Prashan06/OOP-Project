...
class unitTestPig {
 ...
 protected:
  ...
  void testConstructor() {
    ...
    // correct setting.
    if (pig.getSellPrice() != 15 && pig.getBuyPrice() != 12 &&
        pig.getSellTime() == 12 && pig.getHighYieldPrice() == 15) {
  ...
  void testApplyHighYield() {
    ...
    // If statement to check if pigHighYieldApplied is true and money has
    // decreased.
